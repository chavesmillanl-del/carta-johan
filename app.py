...
<div class="carta">
    ...
    <button class="abrir" onclick="iniciar()">
        Abrir carta
    </button>
...
function mostrarFinal(){
    ...
    <div class="carta final">
        ...
        <p>
            Ya sé que esto no es algo nuevo para ti.
        </p>

        <p>
            Pero llevo un tiempo pensando en cómo demostrártelo de una forma diferente.
        </p>

        <p>
            Y aunque podría habértelo dicho en otro mensaje más,
            decidí crear esta pequeña página para recordártelo.
        </p>

        <p>
            Porque algunas personas merecen algo más que un simple "me gustas". ❤️
        </p>
